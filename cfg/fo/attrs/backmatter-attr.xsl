...
<xsl:template match="*[contains(@class, ' map/topicmeta ')]">
  ...
  <xsl:template name="createFrontCoverContents">
    ...
    <xsl:template name="createBackCoverContents">
      <fo:block>
        <!-- <xsl:when test="$map/*[contains(@class, ' bookmap/bookmeta ')]/*[contains(@class, ' xnal-d/authorinformation ')]" as="element()*">
             <xsl:apply-templates select="$map/*[contains(@class, ' bookmap/bookmeta ')]/*[contains(@class, ' xnal-d/authorinformation ')]" as="element()*">
        </xsl:when>

        <xsl:when test="$map/*[contains(@class, ' bookmap/bookmeta ')]/*[contains(@class, ' xnal-d/authorinformation ')]" as="element()*">
            <xsl:value-of select="/descendant::*[contains(@class, ' xnal-d/organizationname ')]" mode="dita-ot:text-only"/>
        </xsl:when>

        <xsl:when test="$map/*[contains(@class, ' bookmap/bookmeta ')]/*[contains(@class, ' xnal-d/authorinformation ')]" as="element()*">
            <xsl:value-of select="descendant::*[contains(@class, ' xnal-d/addressdetails ')]"/>
        </xsl:when>
